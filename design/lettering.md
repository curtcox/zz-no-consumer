...
Use this order when a page contains several text systems:

1. human dialogue and the primary narrative caption;
2. exact machine text needed to understand the action;
3. source labels or provenance markers;
4. incidental interface text and environmental lettering.

No panel may require the reader to parse decorative terminal output before finding its narrative text. Incidental interface text should be illegible, redacted, or omitted when it does not change the story state.
...
## ChatGPT and other interface voices

- ChatGPT appears in rectangular interface-derived text blocks, never a speech balloon.
