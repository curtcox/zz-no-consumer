...
def build_fog_gallery(gallery_document, introduction: str) -> str:
    ...
    body = (
        ...
        'evidence is clear. Nothing inside the map is lettered: propositions and observations are pictograms drawn beneath the '
        'fog, so each can be anywhere from fully visible to invisible, and a key above the map names them. Treatments are listed '
        'in review order, best first. Everything is deterministic standard-library Python. Not exact evidence states beyond the '
        'three the fixtures define; not adopted.</p>'
