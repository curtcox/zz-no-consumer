...
The split from [page 085](085.md) comes back, and a third column is cut into it — narrower than the other two, because it has the least access, the least standing, and the smallest consequence of the three, and the layout should say so before the words do.
