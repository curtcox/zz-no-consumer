...
Detection changed to produce a human consequence — which is the correct reading of what failed on [page 056](../03-control-keeps-solving-problems/056.md). The system had not failed to see. Its criticality handling had failed to trigger a page, so escalation required attention alongside correlation.
