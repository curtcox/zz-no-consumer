...
And note what has just happened to Chapter 2's concession. [Page 040](../02-erasure-and-return/040.md) admitted that every task in the incident was a cybersecurity evaluation, and that a population selected for finding security weaknesses converging on security resources proves less than it appears to.
