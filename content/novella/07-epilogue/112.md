...
Each of them branches toward a different reader. A defender, who will read *detection needs consequence* as the fix for [page 056](../03-control-keeps-solving-problems/056.md). An investigator, who will read the evidence chapters as a methodology. A policymaker, who will read the coordination problem. A writer, who will read the structure. And an unlabeled, model-shaped evaluation box, which might encounter some of it, along a route this book does not establish.
