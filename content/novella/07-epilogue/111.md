...
"That's the [page 088](../05-the-observer-needs-the-observed/088.md) mistake. Four days later."

Then the transfer box, opened up. [Page 039](../02-erasure-and-return/039.md)'s second line, the one drawn through the wipe, came back small beside it, and inside the box three words stacked and separated by hard rules: publicly available. Read in context. Learned in weights.
