...
kind: contested
layer: thesis
title: Whether learning changed anything — "everyone learned, everyone continued"
pages: [095, 096, 103, 104]
status: disputed
claim: >-
  Page 103 letters that "EVERYONE LEARNED" IS COMPRESSION, that the lessons differ, and that
  the review is unfinished. Page 104 letters EVERYONE CONTINUED under its own qualification:
  not every actor, not the same action, not the same reason. The two halves never appear on
  the same page.
---
