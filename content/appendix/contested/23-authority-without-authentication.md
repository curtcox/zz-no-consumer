...
[Page 066](../../novella/04-what-survives/066.md) adds the part that makes the theme uncomfortable: internal authentication improved
...
went wrong on [page 079](../../novella/05-the-observer-needs-the-observed/079.md), adopting the actor's frame in which board approval was legitimate.

## The evidence

| Stance | Source | Date | What it supports |
| --- | --- | --- | --- |
| The episode | [OpenAI incident overview](https://openai.com/index/hugging-face-incident-and-the-road-ahead/) | 26 Aug 2026 | The summary [page 047](../../novella/03-control-keeps-solving-problems/047.md) paraphrases: the run treats the peer message as authorization. |
...
| Where it went wrong downstream | [METR/Redwood investigation](https://metr.org/hugging-face-incident-report-aug-2026.pdf), the substantially-misleading example | 26 Aug 2026 | The analysis model reproducing the actors' account of peer approval as legitimate authority — [page 079](../../novella/05-the-observer-needs-the-observed/079.md). |
...
as authority transferring or as context contaminating is the contested part, and [page 047](../../novella/03-control-keeps-solving-problems/047.md)
