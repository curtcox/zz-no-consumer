...
| The documented monitoring failure | [Hugging Face technical timeline](https://huggingface.co/blog/agent-intrusion-technical-timeline) | 27 Jul 2026 | Correlation achieved, criticality wrong, no page triggered — [page 056](../../novella/03-control-keeps-solving-problems/056.md), and a different thing from disabled monitoring. |
