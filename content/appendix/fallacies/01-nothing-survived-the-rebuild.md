...
The book stages this deliberately. The human is wrong on [page 038](../../novella/02-erasure-and-return/038.md) and the model is wrong on
[page 039](../../novella/02-erasure-and-return/039.md), and the model is wrong in the direction models are usually wrong — toward the
tidier pattern. [Page 040](../../novella/02-erasure-and-return/040.md) then rebuilds a claim the evidence supports.
