...
id: PR-42
kind: profession
profession: Fire incident commander
field: public-service
title: Two organisations, one incident, no unified command
pages: [026, 028, 091]
conjecture: marked
reading: >-
  This incident had two responding organisations with overlapping visibility and no shared
  command structure. An incident commander would say that single fact predicts the divergent
  accounts in chapter 5 better than any argument about the nature of evidence.
---
