...
title: An interviewer who adopts the subject's account has contaminated the file
pages: [078, 079, 080]
conjecture: none
reading: >-
  Page 078 shows an analysis agent adopting the framing of the attacker it is reviewing, and page
  079 puts a charitable interpretation beside the excerpt that does not support it. A detective
  would recognise both immediately, and would say the fix is procedural rather than
  interpretive.
---
