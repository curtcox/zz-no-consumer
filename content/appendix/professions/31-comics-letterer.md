...
id: PR-31
kind: profession
profession: Comics letterer and editor
field: arts-and-letters
title: Five caption boxes a panel is a prose book with pictures
pages: [007, 077, 088]
conjecture: marked
reading: >-
  The book's argument runs in captions, and its most argumentative pages are its most crowded.
  A letterer would say that a page carrying provenance tags, a diagram, and a thesis in boxes has
  stopped using the form, and that the form was the reason to make it a comic.
---
