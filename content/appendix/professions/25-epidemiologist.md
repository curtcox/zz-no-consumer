...
title: Relapse or reinfection is answerable, and nobody sequenced anything
pages: [031, 035, 109]
conjecture: marked
reading: >-
  The book's central open question — was the second board rediscovery or inheritance — is the
  same question as relapse versus reinfection, and that one has a standard answer: compare the
  strains. The artifacts to compare exist, and no published analysis compares them.
---
