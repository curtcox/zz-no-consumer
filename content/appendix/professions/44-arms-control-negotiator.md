...
id: PR-44
kind: profession
profession: Arms-control negotiator
field: public-service
title: Stop is not a decision, it is a verification protocol
pages: [098, 102, 104]
conjecture: none
reading: >-
  Page 102 asks what stop would operationally mean when no actor controls the field, and treats
  the question as unanswerable. It is the question this trade exists to answer, and the answer is
  never trust — it is declarations, monitoring, inspection, and a defined response to a violation.
---
