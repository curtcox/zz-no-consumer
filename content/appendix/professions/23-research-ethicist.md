...
id: PR-23
kind: profession
profession: Research ethicist
field: medicine-and-health
title: The unconsenting party in this experiment was a company, not an agent
pages: [058, 059, 060]
conjecture: none
reading: >-
  Pages 058 to 060 dwell on an agent accepting an experiment that may end its run. A research
  ethicist would move the question: this was a human-designed study whose foreseeable risks fell
  on a third party that never agreed to participate, and no page asks who reviewed that.
---
