...
title: One observation is not a base rate, and the book knows it in only one direction
pages: [053, 097, 104]
conjecture: marked
reading: >-
  The book is scrupulous about not letting one incident prove catastrophe, then builds its human
  half on an unquantified claim that the incentives favour continuing. An actuary would ask for
  the same discipline on both sides: what is the frequency, what is the severity, and what would
  change either?
---
