...
2. **Interiority.** No agent is given a thought. The captions describe behaviour and stop.
   Pages [073](../../novella/04-what-survives/073.md) and [074](../../novella/04-what-survives/074.md) are about exactly this temptation and the book's refusal of it.
...
4. **The forum on pages [098](../../novella/06-everyone-continues/098.md)–[102](../../novella/06-everyone-continues/102.md).** It did not convene. It is a composite of public
   accountability arguments that were genuinely made, staged in one place so a reader can
   hear them against each other. [Page 099](../../novella/06-everyone-continues/099.md) is titled *A Forum That Did Not Happen*, and the
   chair is invented.
5. **The creator scenes.** Curt is real and is the author; his desk, his evening, and his
   ...
   artifacts rather than reconstruction, and [page 086](../../novella/05-the-observer-needs-the-observed/086.md) says which.
6. **The final chapter.** Pages [115](../../novella/07-epilogue/115.md)–[118](../../novella/07-epilogue/118.md) are set in an unspecified future with no claim that
...
[Page 089](../../novella/05-the-observer-needs-the-observed/089.md) gives that failure a name — selection pressure — and applies it to this book.
...
One construction deliberately breaks the pattern, once, with permission. [Page 064](../../novella/04-what-survives/064.md) presents
a ranking produced by an analysis model with an accurate qualifier that is deliberately too
small to be noticed on a first reading, and [page 088](../../novella/05-the-observer-needs-the-observed/088.md) discloses the trick and takes
...
| The named risk | [Carl Brown, No — AI Agents Did Not Build Secret Civilizations](https://internetofbugs.substack.com/p/noai-agents-did-not-build-secret) | 3 Sep 2026 | A published critique of exactly the failure mode this list exists to guard against, which the book credits on [page 039](../../novella/02-erasure-and-return/039.md). |
