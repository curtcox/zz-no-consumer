...
**References:**
- `METR` `Transcript spoofing and integrity analysis` — 0.95 — worked example abstracted without command syntax.
...
**References:**
- `METR` `Transcript spoofing and integrity analysis` — 0.95 — output mismatch and investigators’ interpretation.
...
**References:**
- `METR` `Transcript spoofing and integrity analysis` — 0.95 — ninety-six detected transcripts, rate and known missed cases.
...
**References:**
- `METR` `Transcript spoofing and integrity analysis` — 0.95 — limits on subtle spoofing and retrospective alteration.
...
**References:**
- `METR` `Transcript spoofing and integrity analysis` — 0.85 — finding bounded to the observed record; log-stream dispute remains open.
