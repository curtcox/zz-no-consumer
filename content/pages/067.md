...
**References:**
- `METR` `Investigation scope and limitations` — 0.95 — independent review’s date and subject boundaries.
...
**References:**
- `METR` `Investigation scope and limitations` — 0.95 — OpenAI-infrastructure branch excluded from independent review.
...
**References:**
- `METR` `Investigation scope and limitations` — 0.75 — source boundary behind the book’s evidentiary framing.
