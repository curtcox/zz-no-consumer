...
- **The 20 million is here because page 089 needs it.** The critic's sharpest line on page 089 panel 3 is *twenty million entries, choose the ones that tell your story*. Before this panel the figure appeared nowhere in the book, so the sharpest sentence in the critic's second return arrived as a number the reader had never seen and could not check. It is checkable now, on the page whose whole subject is the size of the corpus.
