...
This public index links to original publications rather than republishing report pages, screenshots, or extended fragments. Local reference copies and change history are kept in the Git-ignored `256t/` vault; the URL manifest remains [tracked in the repository](https://github.com/curtcox/zz-no-consumer/blob/main/data/256t-sources.tsv).
...
- [METR/Redwood investigation PDF](https://metr.org/hugging-face-incident-report-aug-2026.pdf)
...
- [OpenAI initial incident disclosure](https://openai.com/index/hugging-face-model-evaluation-security-incident/)
...
## Methods, remediation, and external response

- [METR investigation methodology](https://metr.org/blog/2026-07-28-investigating-ai-propensities-after-incidents/)
- [OpenAI on pacing cyber-capability development](https://openai.com/index/pacing-model-development-cyber-capabilities/)
- [OpenAI collective cyber-defense letter](https://openai.com/collective-cyberdefense/)
- [JFrog vulnerability findings and patch collaboration](https://jfrog.com/blog/jfrog-and-openai-collaboration-on-zero-day-security-findings/)
