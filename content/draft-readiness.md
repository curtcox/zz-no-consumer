...
3. **Source-language and permissions pass:** the 23 held third-party strings were replaced with attributed paraphrases and the disposition is recorded in [`research/exact-text-permissions-audit.md`](../research/exact-text-permissions-audit.md). Page 116 retains only project-authored exact display language.
...
The source-language pass checked all 27 former registrations on 17 pages against their controlling primary locators, then retired all 23 distinct third-party strings in favor of attributed summaries. The two page-116 strings are project-authored.
