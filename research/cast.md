...
| Carl Brown | Internet of Bugs; self-described sceptic. Published the 3 September critique of the civilization framing (malware, prompt injection, persistence of context) that page 039 paraphrases as `IOB-CIV`, returning on pages 088 and 089. Appears only as text on screen. |
| `SKEPTIC — COMPOSITE` | Disclosed composite window in the creator register (pages 111 and 113) for objections no dated writing makes. No real name, byline, face, or body. Not Carl Brown. On 109 it is right about the book's method and forces a revision; on 111 it makes the publication objection and is answered. |
