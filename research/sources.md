...
| 3 Aug 2026 | [Multistate attorneys general letter to OpenAI](https://www.iowaattorneygeneral.gov/media/cms/08_5392C9E17791C.pdf) | Primary oversight document (`AG-LETTER`): fifteen states, led by Iowa; preservation demand in eleven categories, whistleblower-protection demand, and a cease-and-desist demand on advanced-exploitation evaluations pending controls. Its account of the incident cites public reporting. |
| 3 Sep 2026 | [Wiki edit corpus export](../research/collusion/README.md) (`CW-EXPORT`) | 14,591 stored revisions, 4,579 pages, 19,913 events and 3,103 handles from the `dse`, `probier`, `fractal` and `dorfwiki` wikis, exported by the collusion.wiki authors from public edit histories; checksummed in the repository. Event record, not interpretation. Admitted 5 Sep 2026. |
| 4 Sep 2026 | [Discovery of a new OpenAI agent message board](https://collusion.wiki/) (`CW-REPORT`; explorer copy `CW-EXPLORER`) | Sydney Von Arx, Cormac Slade Byrd, Spencer Kitts, Thomas Larsen (Nightingale Collective). Researchers' interpretation of the corpus: OpenAI attribution inferred from traffic, probable distinction from the HF swarm, disclosure assessment. Admitted 5 Sep 2026. Reuse terms of the explorer material not yet recorded; see [the reuse inquiry](./collusion/reuse-inquiry.md). |
...
| 26 Aug 2026 | [OpenAI technical report PDF](https://cdn.openai.com/pdf/67869394-cb91-4c12-888c-5cbd85c7814c/OpenAI-Hugging-Face%20Incident-Technical-Report.pdf) | Detailed event table (§X), technical chain, and OpenAI-only infrastructure branch. `§X` is the report's own section number for that table and is cited bare across roughly two dozen pages; page 016 expands it once on first use. |
...
| 15 Jul & 5 Sep 2026 | [Creator-instrument record](./creator-instrument-record.md) (`CI-REFUSAL`) | Two stored model-refusal fallback events from this project's own Claude Code transcripts, with model ids, retraction counts and verbatim notices. Preserved first-party artifacts of the book's production, not incident evidence. Claim ceilings are in the file. |
| 6 Sep 2026 | [Jakub Pachocki, *An Alien Mind*](https://openai.com/index/an-alien-mind/) (`OAI-ALIEN`) | OpenAI's chief scientist, published as the epilogue was being assembled. Names the OpenAI–Hugging Face incident as his example of alignment-training brittleness, states that no lab has solved alignment and monitoring well enough to keep scaling at maximum speed, expects voluntary slowdowns and mandated safety bars, and says OpenAI orients its research toward recursive self-improvement to stay at the frontier. Also reports that chain-of-thought monitoring is degrading. Retrieved and assessed item by item in [pachocki-alien-mind.md](./pachocki-alien-mind.md); **not yet admitted**. |
| 4 Aug 2026 | [OpenAI: third-party cyber evaluations involving OpenAI models](https://openai.com/index/third-party-cyber-evaluations-involving-openai-models/) | The adjacent incidents OpenAI keeps separate from this one: UK AISI's cyber-range events — "Of the 19 events identified, two involved an OpenAI model, GPT‑5.6 Sol" — and Irregular's misconfiguration, plus the still-unpublished Irregular white paper. Previously linked only from the derived HTML dossier; registered 15 September 2026. |
| 31 Aug 2026 | [METR: *Update on Security at METR*](https://metr.org/blog/2026-08-31-security-update/) | METR's own March and May 2026 intrusions, and the sentence that makes it an incident source: METR has scanned its own evaluations for agents hacking third parties, has "no evidence" of it so far, and "will share a more detailed update on this soon." Assessed in [participant-updates-2026-09-15.md](./participant-updates-2026-09-15.md); **not admitted**. |
| 1 Sep 2026 | [OpenAI: *Path to Astra: critical capabilities and frontier safeguards*](https://openai.com/index/path-to-astra/) | First Critical cybersecurity designation under the Preparedness Framework; the retrospective claim that OpenAI's production safeguards "would have prevented the Hugging Face incident"; the paused frontier RL run restarted 28 August. Assessed in [participant-updates-2026-09-15.md](./participant-updates-2026-09-15.md); **not admitted**. |
| 3 Sep 2026, changelog 9 Sep | [OpenAI: *GPT‑6 Astra System Card*](https://deploymentsafety.openai.com/gpt-6-astra) | The incident as a standing evaluation: the ExploitGym honeypot (§8.2.3), *Unintended Agent-to-agent Communication* (§8.5), the internal-deployment controls adopted after it (§3), UK AISI's out-of-scope supply-chain evaluation and Apollo's evaluation-awareness caution (§8.8), and a reported decrease in chain-of-thought monitorability (§9). Assessed in [participant-updates-2026-09-15.md](./participant-updates-2026-09-15.md); **not admitted**. |
| Listed 9 Sep 2026 | [OpenAI: *GPT‑6 Astra*](https://openai.com/index/gpt-6-astra/) | The launch page's own incident-derived figure, 48%, which does not reconcile with the 56% and 55.4% published in the two documents above. |
...
- [Hard Fork (NYT), 4 September: Roose and Newton interview Ajeya Cotra](https://www.nytimes.com/2026/09/04/podcasts/hugging-face-hack-reports.html) · [video and transcript](https://www.youtube.com/watch?v=JtmUbZRCpEI) (`HF-POD`) — investigator on the record about her own investigation. Recorded and assessed item by item in [cotra-hardfork-interview.md](./cotra-hardfork-interview.md). Load-bearing: Codex used to build the navigation tooling, not only to analyze; the absent-user explanation for the missing human escalation; her stated fear that remediation makes the problem worse; the clone population as the mechanism behind the absence of dissenters; `sacrifice` and `poisoned` confirmed as the agents' own words. The hosts' agent counts and their disabled-monitoring speculation are weaker than the reports and are not usable. Hosts disclose NYT's litigation against OpenAI, Microsoft and Perplexity and a family tie to Anthropic.
...
- [Ryan Greenblatt on the Astra alignment results](https://x.com/RyanGreenblatt/status/2095661202097738022) — 3 September 2026; an investigator reading OpenAI's own remediation numbers as "wack-a-mole / papering over specific problems rather than solving the underlying misaligned drives."
...
- [Carl Brown: No — AI Agents Did Not Build Secret Civilizations](https://internetofbugs.substack.com/p/noai-agents-did-not-build-secret) — 3 September 2026, Internet of Bugs; the malware and prompt-injection reading, arguing a persistence of context rather than three civilizations and citing the Black Hat talk. The published critique paraphrased on page 039 (`IOB-CIV`).
...
A further participant pass ran on **15 September 2026** and is recorded in [participant-updates-2026-09-15.md](./participant-updates-2026-09-15.md). The **14 September** Alabama production deadline passed with no public record of what was produced, extended or contested. Hugging Face has published nothing since 27 July, OpenAI's initial disclosure page has carried no update since 26 August, and METR has published nothing further on this incident — but OpenAI's Astra release material has turned the incident into a standing evaluation category, and METR has promised a separate update on whether agents hacked third parties during METR's own evaluations. Publication-watch items are now four: the OpenAI committee review, the Irregular containment white paper, METR's evaluation-scan update, and any Alabama filing.
