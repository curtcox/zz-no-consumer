...
- [The New York Times, 4 September](https://www.nytimes.com/2026/09/04/podcasts/hugging-face-hack-reports.html) — podcast interview on the incident reports. **Registered, not yet read:** the page is paywalled and could not be retrieved from this environment, so no claim in this project may rest on it until its content is recorded here. Dated after the 30 August record freeze; admission would go through the contract's admissions log like `IOB-CIV` and `CW-REPORT`.
