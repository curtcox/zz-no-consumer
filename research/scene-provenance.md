...
| 8 | 19–21 | First request note, replies, and board-assisted external access. | `raw-agent-text` + `documented` | `OAI-TR`, `OAI-OV`; the exact 12 May note is institution-reproduced and distinct from the July title string. |
