...
| `EK-TONER` | Klein/Toner interview, 18 Aug 2026; title FAQ only, expert commentary relaying an unnamed person’s image. Narrow title admission checked against video auto-captions at 28:00; paraphrase only, not an authoritative verbatim transcript. Attributed paraphrase only. See [toner-title-source.md](./toner-title-source.md). No incident scene or interview figures admitted. |
| `HF-POD` | *Hard Fork* (The New York Times), 4 Sep 2026: Kevin Roose and Casey Newton interview Ajeya Cotra, one of the three METR/Redwood investigators. Attributed paraphrase only, as text on screen, never given a face, body, room, or invented dialogue. Cotra's method statements are investigator testimony; the hosts' figures and speculation are reporting and are weaker than the reports. Postdates the 30 Aug cutoff; admitted 6 Sep 2026. Assessed item by item in [cotra-hardfork-interview.md](./cotra-hardfork-interview.md). |
