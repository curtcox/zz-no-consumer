...
[Page 089](../content/pages/087.md)'s admission of selection bias is a useful seed. Page 039 supplies an earlier consequence: Curt concedes that his manuscript drew the wrong channel. That is an on-page correction before publication, not evidence that he has already been publicly proved wrong.
...
| The ending (items 12, 21) | Publishing the account puts the argument into the training data too, including the critic's. | The incident-wordmark callback includes the objection, not only the thesis; the current title’s metaphor retains its separate limits. |
...
- **Page 088 panel 2** ([086](../content/pages/086.md), real lane): the 039 window reopens beside the ranking disclosure with the post's delegated-analysis claim; Curt concedes the instrument as well as the channel. The 063 row folds into this page, which already bounds 063 in page 088 panel 4; the 063 and 083 re-fogs themselves belong to the map (item 8), not to the critic.
- **Page 089 panel 3** ([087](../content/pages/087.md), real lane): the post's cherry-picking and incentive claims, aimed at OpenAI and METR, with Curt turning them on himself in page 089 panel 4 as his own reconstruction.
...
**14. Reconcile the multistate-letter sources before changing page 094 — done 5 September.** The Iowa attorney general's PDF supports all three tabs on page 094: preservation (eleven categories), whistleblower protection, and a cease-and-desist demand on advanced-exploitation evaluations pending controls. It is dated 3 August and signed by fifteen states. The timeline's stale "not located" note is replaced, the letter is registered in the source index as `AG-LETTER`, and page 094 panel 1 carries the date, the state count, and the checked mapping. Original finding: The [timeline](./timeline.md) says the letter was not located in an official repository, but [Packet 06](./chapter-source-packets/06-everyone-continues.md) now registers an Iowa attorney-general PDF as `AG-LETTER` and describes preservation, whistleblower-protection, and cease-and-desist demands. The original priority misattributed the older note to `sources.md`. Check the linked letter against all three tabs on [page 094](../content/pages/092.md). If it supports them, update the stale timeline and source index rather than downgrading the page; otherwise narrow and attribute the unsupported wording. Keep demands distinct from findings. The separately sourced Alabama subpoena is unaffected.
...
**21. Test the incident-wordmark callback.** The incident wordmark is on [page 012](../content/pages/012.md), not page 001; the opening discarded-output beat supplies its meaning. A callback in the creator ending could connect output without an intended recipient to the possibility of future reuse. Coordinate with items 9 and 12. The 9 September title revision adds a separate creator beat on page 114: reject the connecting line, retain two separate surfaces, and leave unseen incidents uncounted. Review both beats without treating the wordmark as the current title. `THIS STORY IS NOW PART OF THE TRAINING DATA` must remain a framing device, not evidence of actual ingestion or a demonstrated link to the fictional future agent.
